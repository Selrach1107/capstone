...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT id FROM rider WHERE email = :email");
    ...
    if ($stmt->rowCount() > 0) {
        ...
        try {
            ...
            window.location.href = 'http://localhost/project/rider/rider_verify_otp.php';
          </script>";
...
<body>
        ...
        <form action="rider_forgot_pass.php" method="POST">
