        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="dashboard-card text-center">
                    ...
                    <a href="add_product.php" class="btn mt-3" style="background-color: #8df66a; color: black; padding: 1rem;">Add Product</a>
                </div>
            </div>
            <!-- View Products -->
            <div class="col-md-4">
                <div class="dashboard-card text-center">
                    ...
                    <h5>View Products</h5>
                    <a href="product_list.php" class="btn mt-3" style="background-color: #8df66a; color: black; padding: 1rem;">View Products</a>
                </div>
            </div>
            <!-- Sales Report -->
            <div class="col-md-4">
                <div class="dashboard-card text-center">
                    ...
                    <h5>Sales Report</h5>
                    <a href="#" class="btn mt-3" style="background-color: #8df66a; color: black; padding: 1rem;">View Sales</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="graph-container">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" style="background-color: #8df66a; color: black; padding: 1rem;" type="button" id="reportFilter" data-bs-toggle="dropdown" aria-expanded="false">
                                Select Report Type
                            </button>
