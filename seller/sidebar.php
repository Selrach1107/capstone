        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="seller_dashboard.php"><i class="fa-solid fa-gauge"></i> Dashboard</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="add_category.php"><i class="fa-solid fa-layer-group"></i> Add Category</a></li>
                            <li><a class="dropdown-item" href="add_product.php"><i class="fa-solid fa-square-plus"></i> Add Product</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-warehouse fa-icon"></i>Inventory Management
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="product_list.php"><i class="fa-brands fa-product-hunt"></i> Product Lists</a></li>
                            <li><a class="dropdown-item" href="category_list.php"><i class="fa-solid fa-list"></i> Category Lists</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
